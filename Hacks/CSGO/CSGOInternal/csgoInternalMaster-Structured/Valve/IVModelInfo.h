...
public:
	...
	{
		typedef model_t* (__thiscall* oGetModel)(void*, int);
	...
	int GetModelIndex(const char* Filename)
	{
		...
		return getvfunc<oGetModelIndex>(this, 2)(this, Filename);
	}

	const char* GetModelName(const model_t *model)
	{
		typedef const char* (__thiscall* oGetModelName)(void*, const model_t*);
		return getvfunc<oGetModelName>(this, 3)(this, model);
	}

	void GetModelMaterials(const model_t *model, int count, IMaterial** ppMaterial)
	{
		typedef studiohdr_t* (__thiscall* oGetModelMaterials)(void*, const model_t*, int, IMaterial**);
		getvfunc<oGetModelMaterials>(this, 17)(this, model, count, ppMaterial);
	}

	studiohdr_t* GetStudioModel(const model_t* model)
	{
		typedef studiohdr_t* (__thiscall* oGetStudioModel)(void*, const model_t*);
		return getvfunc<oGetStudioModel>(this, 3)(this, model);
	}
};
