...
public:
	...
	{
		typedef bool(__thiscall* oGetAnalogValue)(void*, AnalogCode_t);
		return getvfunc<oGetAnalogValue>(this, 18)(this, code);
	}

	int GetAnalogDelta(AnalogCode_t code)
	{
		typedef bool(__thiscall* oGetAnalogDelta)(void*, AnalogCode_t);
		return getvfunc<oGetAnalogDelta>(this, 19)(this, code);
	}
	...
	{
		typedef void(__thiscall* oSetCursorPosition)(void*, int, int);
		getvfunc<oSetCursorPosition>(this, 49)(this, x, y);
	}
