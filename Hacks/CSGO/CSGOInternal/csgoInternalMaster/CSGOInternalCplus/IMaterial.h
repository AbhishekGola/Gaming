...
public:
	...
	void IncrementReferenceCount(void)
	{
		...
		return getvfunc< oIncrementReferenceCount >(this, 14)(this);
	}

	void DecrementReferenceCount(void)
	{
		typedef void(__thiscall* oDecrementReferenceCount)(PVOID);
		return getvfunc< oDecrementReferenceCount >(this, 15)(this);
	}
	...
	{
		typedef void (__thiscall* oSetMaterialVarFlag)(void*, MaterialVarFlags_t, bool);
		return getvfunc<oSetMaterialVarFlag>(this, 29)(this, flag, on);
	}

	float GetAlphaModulation()
	{
		typedef float (__thiscall* oGetAlphaModulation)(void*);
