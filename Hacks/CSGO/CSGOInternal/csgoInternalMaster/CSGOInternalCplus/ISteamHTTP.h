...
public:
	...
	// Sets the body for an HTTP BlogPost request.  Will fail and return false on a GET request, and will fail if POST params
...
{
public:
	virtual void Run(HTTPRequestCompleted_t *pvParam) = 0;
	virtual void Run(HTTPRequestCompleted_t *pvParam, bool bIOFailure, SteamAPICall_t hSteamAPICall) = 0;
